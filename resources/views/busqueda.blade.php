...
@section ('content')
	...
	<div class="container">
		<div class="title">
			<h2 class="text-primary">BÚSQUEDA AVANZADA</h2>
		</div>
		<hr>
		<br>
		<article class="col-md-12">
			<div class="row">
				<h4>Esta es la implementación de una búsqueda avanzada para mayor rapidez en la búsqueda de documentos. Las formas de búsquedas que implementamos son:</h4>
			</div>
			<div class="row">
				<h5><strong>1. Escuela Académica > Plan de Estudios > Cursos</strong></h5>
			</div>
			<div class="row">
				<h5><strong>2. Área Académica > Cursos</strong></h5>
			</div>
		</article>
		<br><br>
		<br><br>
